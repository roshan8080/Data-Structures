...
/**
   Initializes instance variables of Knight class 
*/
   ...
   public void move(char direction,int distance)
   {
      ...
      if (super.getHealthPoints() >= 10)
      {
         if (distance < 0)
         {
            ...
            if (direction == 'N')
            {
            // Sets Y-coordinate of Knight after perfoming movement
            ...
            {
            // Sets X-coordinate of Knight after perfoming movement
...
*/
   public boolean attack(GameCharacter target)
   {
      ...
      if (distance <= 2 && !(target.getHealthPoints() < 10))
      {
          // Sets target health point after reducing its health point by 20
